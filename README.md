...
# New Feature - Poker (Texas Hold 'em)

This version of Covey.Town includes a new game feature. 3-6 players can join the new interactable area labeled 'Group 18 Poker Table' and begin playing poker.

This version includes a change in architecture with a more event-oriented focus. GameAreaController.ts and PokerAreaController.ts emit events in the frontend that communicate with townService. These controllers and game functionality derive from the updated shared\types\CoveyTownSocket.d.ts file that includes new interfaces and types for the poker game, primarily seen in PokerGameState.
